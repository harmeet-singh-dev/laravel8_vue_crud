(function($) {
    ...
    /*-------------------------------------
        Sidebar Toggle Menu
      -------------------------------------*/
    $('body').on('click', '.sidebar-nav-item .nav-link', function(e) {
    ...
    $("body").on("click", ".sidebar-toggle", function() {
        $("#wrapper,.dashboard-page-one").toggleClass("sidebar-collapsed");
    });

    /*-------------------------------------
        Sidebar Menu Control Mobile
      -------------------------------------*/
    $("body").on("click", ".sidebar-toggle-mobile", function() {
